...
export default class TaskFormComponent extends Component {
    ...
    handleSave() {
        ...
        dataSave.status = dataSave.status.code;
            ...
            <div className="card">
                <div className="p-fluid p-grid">
                    ...
                    <div className="p-field p-col-12 p-md-12">
                        <span className="p-float-label">
                            <Dropdown id="dropdown" options={cities} optionLabel="name" name="status" value={status} onChange={this.handleChange} />
                    ...
                    <div className="p-formgroup-inline p-col-12">
                        <div className="p-field">
                            <Button label="Primary" onClick={() => this.handleSave()} icon="pi pi-check" />
                        </div>
                        <div className="p-field">
                            <Button label="Danger" icon="pi pi-check" className="p-button-danger" />
                        </div>
                    </div>
                </div>
            </div>
